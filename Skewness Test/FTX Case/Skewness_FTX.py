...
d1 = pd.read_csv('C:/Users/Ronnawat/Desktop/Trading with Python/ลงทุนเป็นระบบ Finlab/Skewness Test/FTX Case/FTX_BTCUSDT.csv', index_col=0, parse_dates=True)
d2 = pd.read_csv('C:/Users/Ronnawat/Desktop/Trading with Python/ลงทุนเป็นระบบ Finlab/Skewness Test/FTX Case/FTX_BULLUSDT.csv', index_col=0, parse_dates=True)
